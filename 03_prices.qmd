...
#| fig-cap: "Correlation among model features. Renewable share and residual load are strongly negatively correlated by construction. temp_centered and temp_squared capture the demand-temperature channel with variance in all seasons."
#| fig-height: 8
...
#| fig-cap: "Post-crisis (2023-2025): with gas prices stabilised, renewable share and residual load emerge as the primary price drivers. Weather (solar, temperature) and thermal dispatch now contribute measurably. The seasonal pattern is clear — renewables dominate summer, residual load dominates shoulder seasons."
#| fig-height: 7
